...
사용법:
  python paddle_rotate_merge.py real_images/1.1.png
  python paddle_rotate_merge.py real_images/          (폴더 전체)

출력: paddle_v2_results/<이름>_v2.png / .json
"""
...
OUTPUT_DIR = Path('paddle_v2_results')
MIN_SCORE = 0.5
