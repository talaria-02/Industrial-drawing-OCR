...
소스:
  ...
  - 실라벨 원본 crop (data/real/train, zone 안쪽만, OOV 제외)

출력: data/generated/train_data_consolidated/{imgs/, train_list.txt, val_list.txt}
...
OUT_DIR = Path('data/generated/train_data_consolidated')
IMG_OUT = OUT_DIR / 'imgs'

SYNTH_SOURCES = [
    'data/generated/synth_symbols/rec_gt.txt',
    'data/generated/synth_symbols_v2/rec_gt.txt',
    'data/generated/synth_symbols_v3/rec_gt.txt',
    'data/generated/stacked_tol_preview/rec_gt.txt',
    'data/generated/line_noise_preview/rec_gt.txt',
    'data/generated/counterbore_bracket_preview/rec_gt.txt',
    'data/generated/real_augment_preview/rec_gt.txt' if Path('data/generated/real_augment_preview/rec_gt.txt').exists() else None,
    'data/generated/priority_v4_preview/rec_gt.txt',
]

V6_DICT = r'C:\Users\zxc20\OneDrive\바탕 화면\ppocr\PaddleOCR\ppocr\utils\dict\ppocrv6_dict.txt'
REAL_LABEL_FILE = Path('data/real/train/Label.txt')
REAL_IMG_DIR = Path('data/real/train')
