...
출력:
  data/generated/stacked_tol_preview/preview.png   (검수용 대조표)
  data/generated/stacked_tol_preview/images/*.png  (개별 crop)
...
OUT_DIR = Path('data/generated/stacked_tol_preview')
