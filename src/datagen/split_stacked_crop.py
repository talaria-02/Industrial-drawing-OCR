...
def main():
    src = Path('data/generated/stacked_tol_preview/images')
    with open('data/generated/stacked_tol_preview/rec_gt.txt', encoding='utf-8') as f:
    ...
    out_dir = Path('data/generated/split_stacked_preview')
