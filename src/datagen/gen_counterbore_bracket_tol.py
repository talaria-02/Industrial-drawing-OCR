...
================================================================================
실라벨 데이터(data/real/train/Label.txt)에서 실사용 확인된 두 패턴:
...
출력: data/generated/counterbore_bracket_preview/preview.png
"""
...
OUT_DIR = Path('data/generated/counterbore_bracket_preview')
