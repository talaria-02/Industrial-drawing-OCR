...
사용법:
  python region_split.py real_images/1.1.png
  python region_split.py real_images/            (폴더 전체)
  # paddle_v2_results/<stem>_v2.json 있으면 검출 분류까지 수행

출력: region_results/<이름>_region.png / _region.json
"""
...
OUTPUT_DIR = Path('region_results')
DET_DIR = Path('paddle_v2_results')
...
def main():
    ...
    target = Path(args[0]) if args else Path('real_images')
