...
DET_CONFIG = r'C:\Users\zxc20\OneDrive\바탕 화면\ppocr\PaddleOCR\configs\det\PP-OCRv5\PP-OCRv5_mobile_det.yml'
DET_WEIGHTS = r'C:\Users\zxc20\OneDrive\바탕 화면\ppocr\pretrain_weights\PP-OCRv5_mobile_det_pretrained'

# 특수기호 많은 실이미지 위주로 선정 (√, ø, GD&T 등 이미 있다고 확인된 것들)
TARGET_IMAGES = [
    r'finetune\labeling\train\BM_part.jpg',
    r'finetune\labeling\train\Gripper.jpg',
    r'finetune\labeling\train\Dessin-ind-Omnifab-vis-page-001-1-2.jpg',
]

OUT_DIR = 'finetune/det_only_check'
