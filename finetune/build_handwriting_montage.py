...
================================================================================================
합성 렌더링이 아니라 실제 도면(finetune/labeling/train)에서 크롭한 진짜 텍스트를 씀 —
...
사용:
  python finetune/build_handwriting_montage.py --n 12 --cols 4 --out finetune/handwriting_test
"""
...
def main():
    ...
    ap.add_argument('--out', default='finetune/handwriting_test')
